...
This figure illustrates the most common way of tokenizing a text---by individual word. 
...
And we can similarly inspect it as follows:

```{r}
inspect(tidy_trump_DTM[1:5,3:8])
```